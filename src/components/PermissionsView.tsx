    ...
    <div id="permissions-view" className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-white/30 text-[10px] font-bold uppercase tracking-widest mb-2">
            ...
            <span>Documents</span>
            <ChevronRight size={12} className="opacity-40" />
            <span className="text-primary">Confidential_Docs</span>
          </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-4 flex flex-wrap items-center justify-between gap-4 shadow-2xl">
        <div className="relative flex-grow max-w-md">
           <input 
            type="text" 
            placeholder="Search users or security groups..."
          ...
          >
            ...
            <div className="flex items-center gap-12">
              <div className="flex flex-col items-center">
                <span className="text-[9px] font-bold uppercase text-white/20 tracking-widest mb-1.5">Access Level</span>
              ...
              <div className="flex items-center gap-4 pl-8 border-l border-white/10">
                {entry.access === 'Admin' && (
                   <label className="relative inline-flex items-center cursor-pointer group/toggle">
                    ...
                    <span className="ml-3 text-xs font-bold text-white/40 group-hover/toggle:text-white transition-colors">Write Access</span>
                  </label>
                )}
                ...
                {entry.access === 'Read & Write' && (
                  <div className="flex items-center gap-2">
                    <button className="px-4 py-1.5 border border-white/10 bg-white/5 rounded-2xl text-xs font-bold text-white/60 hover:bg-white/10 hover:text-white transition-all">Modify</button>
                    <button className="px-4 py-1.5 bg-accent/20 text-accent border border-accent/20 rounded-2xl text-xs font-bold hover:bg-accent hover:text-white transition-all">Revoke</button>
                  </div>
                )}

                {entry.access === 'No Access' && (
                  <button className="px-6 py-1.5 bg-primary text-white rounded-2xl text-xs font-black hover:brightness-110 shadow-2xl shadow-primary/20 transition-all uppercase tracking-tighter">Grant Access</button>
                )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-white/5 backdrop-blur-xl rounded-[40px] p-8 border border-white/10 shadow-2xl">
          <h4 className="text-xl font-bold text-white mb-6 tracking-tight">Permission Inheritance Tree</h4>
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold bg-white/10 px-2 py-0.5 rounded-full text-white/60 uppercase tracking-widest border border-white/5">Inherited</span>
            </div>
            <div className="ml-6 border-l-2 border-white/10 pl-8 space-y-6 relative">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-xs font-black text-white tracking-tight">Confidential_Docs</span>
                <span className="text-[10px] font-bold bg-primary text-white px-2 py-0.5 rounded-full uppercase tracking-widest">Current</span>
              </div>
              <div className="ml-6 border-l-2 border-white/10 pl-8 opacity-40">
                <div className="flex items-center gap-3">
                  <FileText size={16} />
                  <span className="font-mono text-xs font-medium">Q4_Financials.pdf</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-indigo-600/40 to-blue-600/40 backdrop-blur-2xl border border-white/20 rounded-[40px] p-8 shadow-2xl flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            <h4 className="text-xl font-black mb-2 tracking-tighter text-white">Security Check</h4>
            <p className="text-sm font-medium text-white/70 leading-relaxed">
              Detected 3 external users with 'Write' permissions on this node. Review recommended.
            </p>
          </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-bold tracking-tight">Unsaved changes in permissions</span>
        </div>
        <div className="h-6 w-px bg-white/10"></div>
        <div className="flex gap-6">
          <button className="text-sm font-bold text-white/50 hover:text-white transition-colors">Discard</button>
          <button className="bg-primary px-8 py-2 rounded-full text-sm font-black text-white hover:brightness-110 transition-all shadow-xl shadow-primary/20 active:scale-95">Save Changes</button>
        </div>
      </motion.div>
    </div>
  );
